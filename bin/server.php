...
$fibonacciClientRequestQuery = new \Micseres\ServiceHub\Server\Exchange\RequestQuery();
$fibonacciServiceResponseQuery = new \Micseres\ServiceHub\Server\Exchange\RequestQuery();
